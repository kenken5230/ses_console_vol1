...
| Open PRs | No open PRs or open issues as of 2026-06-26 12:50 JST after #146 merge, before this next-approval-gates branch. #114 was closed as superseded; it was not merged. #138 through #146 are closed/merged docs-only sync or planning PRs. | Start any new product/runtime work from latest `origin/main` in a separate clean branch/worktree. |
...
3. Decide whether #149 can move from Draft to Ready/merge after its DB-free SearchHistory UI context test wiring remains green.
