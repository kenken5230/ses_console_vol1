...
| Item | State | Notes |
|---|---|---|
| Snapshot source commit | `76d6a433c64d6a4d494d6f3a284eb25d262bb3c2` | This snapshot was refreshed after approved H2 docs-only PRs #165, #167, and #168 were merged. |
| Recent final PR results | #82-#103 are historical; #104 merged at `7abfaa4`; #105 at `b932ed0`; #106 at `b017e36`; #107 at `1f05e76`; #108 at `03e60e2`; #109 at `afb98ae`; #110 at `b426940`; #111 at `47b96b3`; #112 at `98b41a3`; #113 at `ca15328`; #115 at `5024bf1`; #116 at `43b08db`; #117 at `5c24052`; #118 at `c23c619`; #119 at `ffce54f`; #120 at `f9261f2`; #121 at `b140b75`; #122 at `cbbdeb8`; #123 at `a92031c`; #124 at `8419b4f`; #125 at `d227234`; #126 at `93cf98a`; #127 at `124d9f2`; #128 at `4afb596`; #129 at `10d8342`; #130 at `9506680`; #131 at `d86f2b9`; #132 at `02cd639`; #133 at `bc33a6d`; #134 at `e6c24b9`; #135 at `da053ce`; #136 at `39f3d21`; #137 at `e6d1d6b`; #138 at `4805466`; #139 at `ce0c294`; #140 at `e489508`; #141 at `0265ae0`; #142 at `23c9963`; #143 at `497cd30`; #144 at `66bb643`; #145 at `94952cb`; #146 at `e2f96b9`; #148 at `0ec3778`; #149 at `256a443`; #150 at `17c632b`; #152 at `15b33ef`; #153 at `8df3374`; #155 at `131eb19`; #159 at `24dc716`; #160 at `2169ef3`; #161 at `63531f4`; #162 at `a361450`; #163 at `d379da6`; #164 at `0a292ac`; #165 at `ed5f0c4`; #167 at `4eda582`; #168 at `76d6a43` | Keep only final outcomes here. Details through #87 are in `docs/status/progress-log-2026-06-20.md`; #89 merge/deploy status is in `docs/status/progress-log-2026-06-23.md`; #104-#168 current-state sync is summarized in `docs/status/post163-current-state-2026-06-27.md`, `docs/status/app-entrypoint-baseline-2026-06-27.md`, `docs/status/dbfree-followup-runbooks-2026-06-27.md`, `docs/status/gmail-sync-run-dbfree-diagnostics-2026-06-27.md`, `docs/pmo/standing-authorization-token-policy-2026-06-27.md`, and `docs/status/post-h2-docs-merge-sync-2026-06-29.md`. |
...
|---|---|---|
| AI operating rules | Project-local AGENTS and AI work rules were formalized and then extended through #92, #97, #101, #124, #125, #127, #128, and #129. #159 added `AI_PROJECT_PROFILE.md`, canonical `docs/ai-queue/`, and `scripts/safety-gate.ps1`. #160 through #163 completed the initial LLL/rule foundation follow-up loop. #165/#167/#168 merged H2 runbook/profile/handoff docs. | Follow `AGENTS.md`, `AI_WORK_RULES.md`, `AI_PROJECT_PROFILE.md`, `AI_WORK_RULES_SHORT.md`, and `docs/ai-queue/`. Keep secret files unread and keep risky operations behind approval. H2/H3 are still incomplete because #166 AI safety gate workflow and #169 CODEOWNERS remain manual human-merge items, so delegated automerge/deploy automation remains disabled. |
...
| Open PRs | #166 AI safety gate workflow and #169 CODEOWNERS remain open Draft PRs for human manual review/merge. No open issues as of 2026-06-29 10:20 JST. #147/#151/#154/#156/#157/#158 were closed as superseded or unsafe under the new rules; branch deletion was not performed. | Do not Ready/merge #166/#169 from Codex. Start any new product/runtime work from latest `origin/main` in a separate clean branch/worktree. |
...
2. Complete H2 by human-reviewing and manually merging #166 and #169, then enabling GitHub branch protection / required checks / CODEOWNERS review / token permission restrictions using `docs/pmo/h2-enforcement-runbook.md` and `docs/pmo/h2-handoff-2026-06-27.md`.
3. Complete H1/H3/H4: rule repo git management, standing token handling, and PowerShell policy.
4. Run T-20260627-007 browser entry QA only after production login recovery or safe local/test login preparation.
5. Decide whether #154/#157 equivalents should stay blocked, be redesigned outside `scripts/`, or receive a narrow post-H2 script-hardening exception.
6. Prepare a Person owner link DB-connected preflight only after local/test target classification and fixture approval; DB-free API/route/contract/UI tests are green.
7. Keep Gmail company apply implementation on HOLD until the converged design receives a separate implementation/DB gate approval.
8. Decide how to handle stale worktree metadata permission-denied failures using the permission report; do not run raw deletion, `--force`, worktree remove, or branch deletion without a new explicit plan.
9. Decide whether CSV/source tracking can move from HOLD to a local/test DB schema verification gate; DB-free tests are green, but do not run migration/schema/apply yet.
...
- Post-H2 docs merge sync: `docs/status/post-h2-docs-merge-sync-2026-06-29.md`
