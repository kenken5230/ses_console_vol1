...
| Item | State | Notes |
|---|---|---|
| Latest `origin/main` | `d22723456031af3ed90b6043c1ac87ea9dceb763` | Main commit after PR #125 merge: `Add cross-project AI rule rollout templates (#125)`. |
| Recent final PR results | #82-#103 are historical; #104 merged at `7abfaa4`; #105 at `b932ed0`; #106 at `b017e36`; #107 at `1f05e76`; #108 at `03e60e2`; #109 at `afb98ae`; #110 at `b426940`; #111 at `47b96b3`; #112 at `98b41a3`; #113 at `ca15328`; #115 at `5024bf1`; #116 at `43b08db`; #117 at `5c24052`; #118 at `c23c619`; #119 at `ffce54f`; #120 at `f9261f2`; #121 at `b140b75`; #122 at `cbbdeb8`; #123 at `a92031c`; #124 at `8419b4f`; #125 at `d227234` | Keep only final outcomes here. Details through #87 are in `docs/status/progress-log-2026-06-20.md`; #89 merge/deploy status is in `docs/status/progress-log-2026-06-23.md`; #104-#125 current-state sync is summarized in `docs/status/post112-current-state-2026-06-24.md`. |
...
|---|---|---|
| AI operating rules | Project-local AGENTS and AI work rules were formalized and then extended through #92, #97, #101, #124, and #125. | Follow `AGENTS.md`, `AI_WORK_RULES.md`, and `AI_WORK_RULES_SHORT.md`; keep secret files unread and keep risky operations behind approval. |
...
| Open PRs | No product/runtime PRs open as of 2026-06-24 16:55 JST; only this docs-only status-sync PR may be open while under review. #114 was closed as superseded; it was not merged. | Start any new product/runtime work from latest `origin/main` in a separate clean branch/worktree. |
