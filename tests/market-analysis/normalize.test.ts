...
assert.equal(toPriceBand(30.001), "30_35");
assert.equal(toPriceBand(49.999), "45_50");
assert.equal(toPriceBand(50), "50_55");
assert.equal(toPriceBand(59.999), "55_60");
assert.equal(toPriceBand(60), "60_65");
assert.equal(toPriceBand(70), "70_75");
assert.equal(toPriceBand(80), "80_85");
assert.equal(toPriceBand(119.999), "115_120");
