...

{
  ...
  assert.equal(report.summary.fileRows, 4);
  assert.equal(report.summary.parsedRows, 4);
  assert.equal(report.summary.effectiveTypes.project, 4);
  ...
  assert.equal(report.sampleRows.length, 4);
...

{
  ...
  assert.equal(report.summary.effectiveTypes.person, 4);
