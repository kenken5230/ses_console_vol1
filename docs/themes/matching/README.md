...
- `match-suggestion-review-update-fix-list-v0.1.md`: Claude Code investigation summary converted into next-PR fix points, guard requirements, test coverage, and forbidden operations.
