...
| [`post143-next-gates-2026-06-26.md`](./post143-next-gates-2026-06-26.md) | Current gate summary | Current state after #143, with next gates for production read-only QA, Person owner link preflight, SearchHistory smoke, cleanup permissions, Gmail apply, and CSV/source tracking. |
| [`dbfree-verification-refresh-2026-06-26.md`](./dbfree-verification-refresh-2026-06-26.md) | Validation report | DB-free verification refresh after #144: Person owner link, SearchHistory, Gmail extraction quality, CSV dry-run, and source tracking tests passed; DB-connected work remains gated. |
| [`auth-login-readiness-2026-06-26.md`](./auth-login-readiness-2026-06-26.md) | Status report | Secret-safe login readiness diagnostic and runbook for shared login failure, password reset, SMTP, and active-user password-hash checks. |
...
| [`../pmo/worktree-cleanup-permission-investigation-2026-06-26.md`](../pmo/worktree-cleanup-permission-investigation-2026-06-26.md) | Cleanup investigation packet | Planning-only permission investigation after Batch A prune failed with `.git/worktrees/... Permission denied`; forbids raw deletion and force flags. |
| [`../pmo/worktree-cleanup-permission-report-2026-06-26.md`](../pmo/worktree-cleanup-permission-report-2026-06-26.md) | Cleanup investigation report | Read-only permission report showing 22 stale metadata directories all have `ReadOnly, Directory, Archive, ReparsePoint` attributes; cleanup remains approval-gated. |
| [`../pmo/next-approval-gates-2026-06-26.md`](../pmo/next-approval-gates-2026-06-26.md) | Approval packet | Consolidated next approval choices for production read-only QA, Person owner link preflight, SearchHistory smoke, worktree cleanup permission handling, Gmail apply implementation, and CSV/source tracking schema gates. |
| [`../pmo/csv-source-tracking-integration-decision-2026-06-26.md`](../pmo/csv-source-tracking-integration-decision-2026-06-26.md) | CSV/source tracking decision packet | Decision packet noting repo source-tracking schema exists while real target DB schema/apply remains approval-gated. |
