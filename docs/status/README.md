...
| [`../pmo/approval-waiting-packet-2026-06-24.md`](../pmo/approval-waiting-packet-2026-06-24.md) | Approval packet | Current owner-gated work after #139: production read-only QA, Person owner link preflight, Gmail company apply, optional SearchHistory smoke, cleanup planning, and CSV apply block. |
