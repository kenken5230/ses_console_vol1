...
| [`../pmo/approval-waiting-packet-2026-06-24.md`](../pmo/approval-waiting-packet-2026-06-24.md) | Approval packet | Current owner-gated work after #129: production read-only QA, cleanup planning, Person owner link preflight, Gmail company apply, optional SearchHistory smoke, and CSV apply block. |
