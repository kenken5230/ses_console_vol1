...
| [`project-company-contact-role-link-ready-checklist-2026-06-21.md`](./project-company-contact-role-link-ready-checklist-2026-06-21.md) | Runbook/status report | PR #89 Ready checklist separating Not run, Blocked, Pass, and Fail for DB classification, real DB write smoke, Browser QA, and approval gates. |
