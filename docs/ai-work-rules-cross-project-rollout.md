...
10. 文字化け、BOM、削除差分、秘密情報混入を確認する。
11. ルール導入PRを作り、docs-onlyとして内部監査を通す。
12. main mergeがproduction deployを起動するrepoでは、docs-onlyでもdeploy影響を確認してからmergeする。
...
- heartbeatごとに全テーマを見て、安全作業を進め、危険ゲートで止め、次回へ引き継ぐ
